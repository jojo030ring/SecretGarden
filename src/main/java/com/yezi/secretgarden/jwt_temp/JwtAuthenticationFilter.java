...
public class JwtAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        loggerService.infoLoggerTest("JwtAuthenticationFilter > 진입");
        ...
        try {
            ...
            loggerService.infoLoggerTest(userRequestDto.toString());
            loggerService.infoLoggerTest("JwtAuthenticationFilter > "+userRequestDto.toString());
            ...
            loggerService.infoLoggerTest("JwtAuthenticationFilter > username : "+authenticationToken.getPrincipal());
            loggerService.infoLoggerTest("JwtAuthenticationFilter > password : "+authenticationToken.getCredentials());


            /**
             * <PrincipalDetailsService의 loadUserByUsername() 함수가 실행되었을 때 일어나는 일>
             * -authenticate() 함수가 호출 되면 인증 프로바이더가 유저 디테일 서비스의
             * -loadUserByUsername토큰의 첫번째 파라메터(username)를 호출하고
